...
const About = () => {
  return (
    <Container className="bg-grey-400">
      <div className='flex max-md:flex-col-reverse justify-between gap-10 items-center py-4'>
        <div className="md:w-3/5 flex items-center gap-6">
        ...
        <div className="md:w-2/5">
          ...
          <div><Button style='btn_light' to='./gallery' text='Read More' /></div>
        </div>
      </div>
    </Container>
  )
